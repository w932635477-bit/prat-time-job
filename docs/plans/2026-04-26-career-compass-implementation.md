# Career Compass (经验变现导航器) Implementation Plan

> **For Claude:** REQUIRED SUB-SKILL: Use superpowers:executing-plans to implement this plan task-by-task.

**Goal:** Build the Career Compass MVP — an AI-powered skill engine that guides unemployed mid-career professionals through self-discovery, offer creation, and first launch.
...
**Files:**
- Create: `career-compass/pyproject.toml`
- Create: `career-compass/src/career_compass/__init__.py`
- Create: `career-compass/src/career_compass/config.py`
- Create: `career-compass/tests/conftest.py`

**Step 1: Create project directory and pyproject.toml**

```bash
mkdir -p career-compass/src/career_compass
mkdir -p career-compass/tests
```

```toml
# career-compass/pyproject.toml
[project]
name = "career-compass"
version = "0.1.0"
description = "AI变现合伙人 — 帮助中年失业者将行业经验转化为收入"
...
```python
# career-compass/src/career_compass/config.py
...
```python
# career-compass/src/career_compass/__init__.py
...
```python
# career-compass/tests/conftest.py
import asyncio
import pytest
...
```
# career-compass/.env.example
CC_DEEPSEEK_API_KEY=your-api-key-here
CC_DATABASE_PATH=career_compass.db
```
...
python -c "from career_compass.config import settings; print('OK')"
```
Expected: `OK`
...
```bash
cd ..
git add career-compass/
git commit -m "chore: scaffold career-compass project"
```
...
**Files:**
- Create: `career-compass/src/career_compass/models.py`
- Create: `career-compass/tests/test_models.py`

**Step 1: Write the test**

```python
# career-compass/tests/test_models.py
from career_compass.models import (
...
```bash
cd career-compass && python -m pytest tests/test_models.py -v
```
Expected: FAIL — `ModuleNotFoundError: No module named 'career_compass.models'`

**Step 3: Write the implementation**

```python
# career-compass/src/career_compass/models.py
...
```bash
cd .. && git add career-compass/src/career_compass/models.py career-compass/tests/test_models.py
git commit -m "feat: add Career Compass data models"
```
...
**Files:**
- Create: `career-compass/src/career_compass/llm/__init__.py`
- Create: `career-compass/src/career_compass/llm/client.py`
- Create: `career-compass/src/career_compass/llm/prompts.py`
- Create: `career-compass/tests/test_llm/test_client.py`

**Step 1: Write the test**

```python
# career-compass/tests/test_llm/test_client.py
import pytest
from unittest.mock import AsyncMock, patch
from career_compass.llm.client import DeepSeekClient
from career_compass.llm.prompts import PromptBuilder
...
async def test_client_sends_chat_request():
    ...
    mock_response.json.return_value = {
        "choices": [{"message": {"content": "你好！欢迎来到经验变现导航器。"}}]
    }
    mock_response.status_code = 200
    mock_response.raise_for_status = lambda: None

    with patch("career_compass.llm.client.httpx.AsyncClient") as mock_client_cls:
...
```bash
cd career-compass && python -m pytest tests/test_llm/test_client.py -v
```
...
```python
# career-compass/src/career_compass/llm/__init__.py
"""LLM client for DeepSeek API."""
```

```python
# career-compass/src/career_compass/llm/client.py
from __future__ import annotations
...
```python
# career-compass/src/career_compass/llm/prompts.py
from __future__ import annotations
...
```bash
cd career-compass && python -m pytest tests/test_llm/ -v
```
...
```bash
cd .. && git add career-compass/src/career_compass/llm/ career-compass/tests/test_llm/
...
**Files:**
- Create: `career-compass/src/career_compass/confidence/__init__.py`
- Create: `career-compass/src/career_compass/confidence/engine.py`
- Create: `career-compass/src/career_compass/confidence/patterns.py`
- Create: `career-compass/tests/test_confidence/test_engine.py`

**Step 1: Write the test**

```python
# career-compass/tests/test_confidence/test_engine.py
from career_compass.confidence.engine import ConfidenceEngine
from career_compass.confidence.patterns import NEGATIVE_PATTERNS
from career_compass.models import ConfidenceLevel
...
```bash
cd career-compass && python -m pytest tests/test_confidence/ -v
```
Expected: FAIL
...
```python
# career-compass/src/career_compass/confidence/__init__.py
"""Confidence rebuilding engine."""
```

```python
# career-compass/src/career_compass/confidence/patterns.py
NEGATIVE_PATTERNS = [
    "我不行",
    "我做不到",
    "没什么用",
...
```python
# career-compass/src/career_compass/confidence/engine.py
from __future__ import annotations
...
```bash
cd .. && git add career-compass/src/career_compass/confidence/ career-compass/tests/test_confidence/
...
**Files:**
- Create: `career-compass/src/career_compass/engine/__init__.py`
- Create: `career-compass/src/career_compass/engine/skill_base.py`
- Create: `career-compass/tests/test_engine/test_skill_base.py`

**Step 1: Write the test**

```python
# career-compass/tests/test_engine/test_skill_base.py
from career_compass.engine.skill_base import BaseSkill, StepResult
from career_compass.models import Step, StepOption, SkillStepResult
...
```bash
cd career-compass && python -m pytest tests/test_engine/test_skill_base.py -v
```

**Step 3: Write the implementation**

```python
# career-compass/src/career_compass/engine/__init__.py
"""Skill engine core components."""
```

```python
# career-compass/src/career_compass/engine/skill_base.py
from __future__ import annotations

from abc import ABC, abstractmethod
from dataclasses import dataclass, field

from career_compass.models import Step, UserState
...
```bash
cd .. && git add career-compass/src/career_compass/engine/skill_base.py career-compass/tests/test_engine/test_skill_base.py career-compass/src/career_compass/engine/__init__.py
...
**Files:**
- Create: `career-compass/src/career_compass/engine/registry.py`
- Create: `career-compass/tests/test_engine/test_registry.py`

**Step 1: Write the test**

```python
# career-compass/tests/test_engine/test_registry.py
...
```bash
cd career-compass && python -m pytest tests/test_engine/test_registry.py -v
```

**Step 3: Write the implementation**

```python
# career-compass/src/career_compass/engine/registry.py
from __future__ import annotations
...
```bash
cd .. && git add career-compass/src/career_compass/engine/registry.py career-compass/tests/test_engine/test_registry.py
...
**Files:**
- Create: `career-compass/src/career_compass/engine/state.py`
- Create: `career-compass/tests/test_engine/test_state.py`

**Step 1: Write the test**

```python
# career-compass/tests/test_engine/test_state.py
import pytest
import tempfile
from pathlib import Path
...
```bash
cd career-compass && python -m pytest tests/test_engine/test_state.py -v
```

**Step 3: Write the implementation**

```python
# career-compass/src/career_compass/engine/state.py
from __future__ import annotations
...
```bash
cd .. && git add career-compass/src/career_compass/engine/state.py career-compass/tests/test_engine/test_state.py
...
**Files:**
- Create: `career-compass/src/career_compass/skills/__init__.py`
- Create: `career-compass/src/career_compass/skills/self_discovery.py`
- Create: `career-compass/tests/test_skills/test_self_discovery.py`

**Step 1: Write the test**

```python
# career-compass/tests/test_skills/test_self_discovery.py
...
```bash
cd career-compass && python -m pytest tests/test_skills/test_self_discovery.py -v
```

**Step 3: Write the implementation**

```python
# career-compass/src/career_compass/skills/__init__.py
"""Career Compass skills."""
```

```python
# career-compass/src/career_compass/skills/self_discovery.py
from __future__ import annotations
...
```bash
cd .. && git add career-compass/src/career_compass/skills/ career-compass/tests/test_skills/
...
**Files:**
- Create: `career-compass/src/career_compass/skills/plan_path.py`
- Create: `career-compass/src/career_compass/skills/take_action.py`
- Create: `career-compass/src/career_compass/skills/troubleshoot.py`
- Create: `career-compass/tests/test_skills/test_plan_path.py`
- Create: `career-compass/tests/test_skills/test_take_action.py`
- Create: `career-compass/tests/test_skills/test_troubleshoot.py`

**Step 1: Write the tests**

```python
# career-compass/tests/test_skills/test_plan_path.py
...
```python
# career-compass/tests/test_skills/test_take_action.py
...
```python
# career-compass/tests/test_skills/test_troubleshoot.py
...
```bash
cd career-compass && python -m pytest tests/test_skills/ -v
```

**Step 3: Write the implementations**

```python
# career-compass/src/career_compass/skills/plan_path.py
from __future__ import annotations
...
```python
# career-compass/src/career_compass/skills/take_action.py
from __future__ import annotations
...
```python
# career-compass/src/career_compass/skills/troubleshoot.py
from __future__ import annotations
...
**Files:**
- Create: `career-compass/src/career_compass/engine/runner.py`
- Create: `career-compass/tests/test_engine/test_runner.py`

**Step 1: Write the test**

```python
# career-compass/tests/test_engine/test_runner.py
import pytest
from unittest.mock import AsyncMock, MagicMock
from career_compass.engine.runner import SkillRunner
from career_compass.engine.registry import SkillRegistry
from career_compass.engine.state import StateManager
from career_compass.engine.skill_base import StepResult
from career_compass.models import (
...
```bash
cd career-compass && python -m pytest tests/test_engine/test_runner.py -v
```

**Step 3: Write the implementation**

```python
# career-compass/src/career_compass/engine/runner.py
from __future__ import annotations
...
class SkillRunner:
    ...
    async def process_message(
        ...
        from career_compass.models import SkillStepResult
...
```bash
cd .. && git add career-compass/src/career_compass/engine/runner.py career-compass/tests/test_engine/test_runner.py
...
**Files:**
- Create: `career-compass/src/career_compass/main.py`

**Step 1: Write the implementation**

```python
# career-compass/src/career_compass/main.py
from __future__ import annotations
...
```bash
cd career-compass && python -c "from career_compass.main import app; print('App created:', app.title)"
```
Expected: `App created: Career Compass API`

**Step 3: Commit**

```bash
cd .. && git add career-compass/src/career_compass/main.py
...
**Files:**
- Create: `career-compass/frontend/` (full Next.js app)
...
```typescript
// career-compass/frontend/src/lib/api.ts
...
```tsx
// career-compass/frontend/src/app/page.tsx
"use client";
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <header className="bg-white shadow-sm px-4 py-3 flex items-center justify-between">
        <h1 className="text-lg font-bold text-gray-900">经验变现导航器</h1>
...
```bash
cd career-compass/frontend && npm run build
```
...
```bash
cd ../.. && git add career-compass/frontend/
...
**Files:**
- Create: `career-compass/tests/test_integration.py`

**Step 1: Write the test**

```python
# career-compass/tests/test_integration.py
import pytest
from pathlib import Path
...
from career_compass.engine.state import StateManager
from career_compass.engine.runner import SkillRunner
from career_compass.models import ChatRequest
...
```bash
cd career-compass && python -m pytest tests/test_integration.py -v
```
Expected: PASS
...
```bash
cd .. && git add career-compass/tests/test_integration.py
...
```bash
cd career-compass && python -m pytest tests/ -v --tb=short
```
...
```bash
cd career-compass && DEEPSEEK_API_KEY=your-key python -m career_compass.main
```

**Step 3: Start the frontend (separate terminal)**

```bash
cd career-compass/frontend && npm run dev
```
